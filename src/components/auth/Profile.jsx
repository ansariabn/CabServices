								...
								<table className="table table-bordered table-hover shadow">
									<thead>
										<tr>
											...
											<th scope="col">cabs Type</th>
											<th scope="col">Travel In Date</th>
											<th scope="col">Travel Out Date</th>
									...
									<tbody>
										{bookings.map((booking, index) => (
											<tr key={index}>
												...
												<td>
													{moment(booking.travelInDate).subtract(1, "month").format("MMM Do, YYYY")}
												</td>
												<td>
													{moment(booking.travelOutDate)
														.subtract(1, "month")
														.format("MMM Do, YYYY")}
												</td>
